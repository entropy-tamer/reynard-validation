...
describe("Advanced Validators", () => {
  describe("validatePasswordStrength", () => {
    it("should analyze password strength correctly", () => {
      ...
      expect(strongResult.feedback).toBe("very-strong");
...
describe("ValidationUtils", () => {
  ...
  describe("validateFields", () => {
    it("should validate multiple fields", () => {
      ...
      const result = ValidationUtils.validateFields(data, FormSchemas.registration);

      expect(result.isValid).toBe(true);
      expect(result.results.email.isValid).toBe(true);
      expect(result.results.username.isValid).toBe(true);
      expect(result.results.password.isValid).toBe(true);
